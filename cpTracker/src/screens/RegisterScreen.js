...
onSubmit = async () => {
  ...
  render() {
    return (
      ...
      <View><Text style={{color:"#9CD66E", alignSelf:"center", fontSize:30, fontWeight:'bold', marginTop:20}}>CP Tracker</Text></View>  
           <View style={[Styles.Card2]}>
           <View><Text style={[Styles.Headers2]}>Register</Text></View> 
                 ...
                 <View style={Styles.flexRow}>
                     <Text>Have an Account? </Text>
                       <TouchableOpacity onPress={()=>{this.props.navigation.navigate('SignIn')}}>
                            <Text style={{fontWeight:'bold',color:'#3f4584'}}>Sign In</Text>
                        </TouchableOpacity>
                    </View>
